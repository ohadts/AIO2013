...
namespace Teboscreen
{
    ...
    public partial class Form1 : Form
    {
        ...
        Pen EraserPen = new Pen(Color.FromArgb(255, 255, 192), 5);
        ...
        public void SaveSelection(bool showCursor)
        {
            ...
            if (ScreenPath != "" || ScreenShot.saveToClipboard)
            {
                ...
                if (ScreenShot.saveToClipboard)
                {
                    ...
                    MessageBox.Show("Area saved to clipboard", "AIO2013", MessageBoxButtons.OK);
                ...
                else
                {
                    ...
                    MessageBox.Show("Area saved to file", "AIO2013", MessageBoxButtons.OK);
            ...
            else
            {
                ...
                MessageBox.Show("File save cancelled", "AIO2013", MessageBoxButtons.OK);
                this.InstanceRef.Show();
                this.Close();
                this.Dispose(true);
